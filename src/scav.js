...
// Logika obliczeniowa mieszka w scav-logika.js — tutaj tylko warstwa panelu.
// Re-eksport zachowuje dotychczasowe API tego modulu.
export {
  POZIOMY, JEDNOSTKI_OK, NOSNOSC_JEDNOSTKI, walidujKrok, walidujKroki,
...
import {
  POZIOMY, JEDNOSTKI_OK, walidujKrok, walidujKroki,
  sparsujParametrySwiata, czasKrokuSekundy, formatCzas,
  losowyOdstep, wczytajZapisaneKroki, zapiszKroki,
} from './scav-logika.js';
